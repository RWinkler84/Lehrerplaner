...
export let timetableChanges = [
    ...
    { "id": "7", "date": "2025-06-24", "timeslot": "6", "class": "Egs", "subject": "Termin", "canceled": "false", "type": "appointement", "lastEdited": "2025-06-19 13:43:37" },
...
async function startApp() {
    ...
    function setCalendarWeek() {
        ...
        let referenceDate = new Date('2025-06-16').setHours(12, 0, 0, 0);
    ...
    function setDateForWeekdays() {
        let todayUnix = new Date('2025-06-16').setHours(12, 0, 0, 0);
